...
void CEF_CALLBACK print_callback_on_print_finished(
    struct _cef_print_callback_t* self, int ok) {
  ...
  // Execute
  CefPrintCallbackCppToC::Get(self)->OnPrintFinished(
      ok?true:false);
}
...
template<> CefRefPtr<CefPrintCallback> CefCppToC<CefPrintCallbackCppToC,
...
#ifndef NDEBUG
template<> base::AtomicRefCount CefCppToC<CefPrintCallbackCppToC,
    CefPrintCallback, cef_print_callback_t>::DebugObjCt = 0;
#endif

template<> CefWrapperType CefCppToC<CefPrintCallbackCppToC, CefPrintCallback,
